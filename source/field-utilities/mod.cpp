name = "Pontifex: Field Utilities"; // The name of your mod
picture = "yfu_1x2.paa"; // Path to the mod icon
logo = "yfu_1x1.paa"; // Small icon displayed in the main menu
...
overview = "A suite of field utilities by Yoshi"; // A brief overview or description of your mod
