...
TRIBUNAL_SCENARIO = Scenario(
    ...
    mission_entities=(
        ...
        MissionEntity("TRIBUNAL_FW_ZEUS_TARGET", "C_Plane_Civil_01_F", "A3_Air_F_Exp_Plane_Civil_01", "Object", (2000,6,5600)),
        MissionEntity("TRIBUNAL_FW_CONTROL", "C_Plane_Civil_01_F", "A3_Air_F_Exp_Plane_Civil_01", "Object", (2050,6,5600)),
    ),
