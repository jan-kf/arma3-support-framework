...
| Field Utilities | 20 | ~99% | ~99% | FPV authority/effects, broader contact topology, airdrop feedback, ponds/other Fabricator matrices, towing locality breadth |
...
| **Overall** | **100** | **~97%** | **~87%** | weighted combination above |
