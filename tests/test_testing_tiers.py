...
class TierFrameworkTests(unittest.TestCase):
    ...
    def test_vigil_transport_product_refinements_are_fail_closed(self) -> None:
        ...
        self.assertIn('[_vehicle, "transport", [_destPos, _maxAlt, _do_not_climb, _ignoreEn, "dispatch"]]', request)
    ...
    def test_vigil_cas_is_scoped_fail_closed_and_uses_real_rtb(self) -> None:
        ...
        self.assertIn('[_vehicle, "cas", [_location, _altitude, _time_limit]] call YSF_taskRequestRemote', request)
